...
# v6 is the first standardized-space SDXL MLP baseline.
#
# Intent:
# - train on featurewise-standardized Qwen inputs and SDXL targets
# - keep the current MLP architecture and plain output path by default
# - use MSE + cosine + moderate log-norm pressure
# - avoid reintroducing aggressive raw direct-norm matching as the primary fix
...
export RUN_LABEL="${RUN_LABEL:-std_v6_mlp_mse_plain}"
...
export TRAIN_SDXL_SPECTRAL_NORM="${TRAIN_SDXL_SPECTRAL_NORM:-0}"
